...
export class Member extends Model {
	...
	private itemId__DO_NOT_USE_THIS_OR_KITTENS_WILL_DIE?: number;
	...
	constructor(args: IMemberArgs) {
		...
		this.itemId__DO_NOT_USE_THIS_OR_KITTENS_WILL_DIE = args.itemId;
	...
	public setValueFromAPI(args: any) {
		...
		if (!Number.isNaN(itemId)) {
			this.itemId__DO_NOT_USE_THIS_OR_KITTENS_WILL_DIE = itemId;
		}
