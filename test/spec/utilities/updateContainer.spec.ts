...
describe('UpdateContainer', () => {
	...
	describe('XML', () => {
		it('should create an update XML', () => {
			...
			const expectedXML = '<asset fieldId="Container1"><metafield fieldId="Container1Field1" ' +
				'standardGuid="17C54460-E6CC-4BDA-ABE3-628532617EBD"/><state fieldId="Container1Field2"/>' +
				'<layoutIsPublic fieldId="Container1Field3"/></asset>';
	...
	describe('JSON', () => {
		it('should create an update JSON', () => {
			...
			// language=JSON
			const expectedJSON = '{"Id":"Container1","FieldId":"Container1","FieldName":"asset","ContainerType":7,' +
				'"ItemIds":[9963],"RowId":1,"Values":[{"FieldId":"Container1Field1","Type":2,"Values":[0]},' +
				'{"FieldId":"Container1Field2","Type":3,"Values":[-1]},{"FieldId":"Container1Field3",' +
				'"Type":2,"Values":[0]}]}';
